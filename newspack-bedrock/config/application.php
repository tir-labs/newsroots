...
/** Memcached object cache — Roots Trellis default. Redis is not used. */
Config::define('MEMCACHED_HOST', env('MEMCACHED_HOST') ?: '127.0.0.1');
Config::define('MEMCACHED_PORT', (int) (env('MEMCACHED_PORT') ?: 11211));
Config::define('MEMCACHED_PERSISTENT_ID', env('MEMCACHED_PERSISTENT_ID') ?: 'newspack-bedrock');
