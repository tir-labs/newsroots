...
// Public API: GET https://example.com/wp-json/wp/v2/posts?slug=sample-post
// Public API: GET https://example.com/wp-json/wp/v2/product?slug=sample-post
...
add_action('rest_api_init', function () {
    register_rest_route('fifu-premium/v2', '/debug-slug/(?P<slug>[a-z0-9-_]+)', array(
        'methods' => 'GET',
    ...
    register_rest_route('fifu-premium/v2', '/debug-postmeta/(?P<post_id>\d+)', array(
        'methods' => 'GET',
    ...
    register_rest_route('fifu-premium/v2', '/debug-posts/(?P<id>\d+)', array(
        'methods' => 'GET',
    ...
    register_rest_route('fifu-premium/v2', '/debug-metain/', array(
        'methods' => 'GET',
    ...
    register_rest_route('fifu-premium/v2', '/debug-metaout/', array(
        'methods' => 'GET',
    ...
    register_rest_route('fifu-premium/v2', '/debug-log/(?P<type>(cloud|plugin))', array(
        'methods' => 'GET',
