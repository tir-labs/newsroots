...
class FIFU_GF_Video_Field extends GF_Field {

    /**
     * @var string $type The field type.
     */
    public $type = 'fifu_video';
    ...
    public function get_form_editor_field_title() {
        ...
        return $strings['field']['video']() . ' (FIFU)';
    }
    ...
    public function get_field_input($form, $value = '', $entry = null) {
        ...
        $placeholder_attribute = 'placeholder="' . $strings['placeholder']['video']() . '"';
    ...
    public function get_value_save_entry($value, $form, $input_name, $lead_id, $lead) {
        ...
        $_POST['fifu_video_input_url'] = $value;
...
GF_Fields::register(new FIFU_GF_Video_Field());
