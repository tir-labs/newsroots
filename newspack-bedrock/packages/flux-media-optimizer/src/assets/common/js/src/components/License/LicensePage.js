 ...
 * @since 1.2.1 Browse and support links include suite UTM parameters.
 */
    ...
    <PageLayout title={__('Flux Suite - License', 'flux-plugins-common')}>
          ...
          <Stack spacing={3}>
            ...
            {licenseKey && licenseData?.license_is_valid ? (
              <Typography variant="body1" color="text.secondary">
                ...
                <Link
                  href="https://fluxplugins.com?utm_source=flux-suite&utm_medium=plugin&utm_campaign=license-browse&utm_content=license-page-browse"
                  target="_blank"
      ...
      <Box sx={{ mt: 4, pt: 4, borderTop: 1, borderColor: 'divider' }}>
        ...
        <Typography variant="caption" color="text.secondary" sx={{ mb: 2, display: 'block' }}>
          ...
          <Link href="https://fluxplugins.com/contact-support/?utm_source=flux-suite&utm_medium=plugin&utm_campaign=support&utm_content=license-account-id" target="_blank" rel="noopener noreferrer" sx={{ color: 'primary.main' }}>
