...
use FluxMedia\Symfony\Component\Process\ProcessBuilder;
...
class ProcessBuilderFactory implements ProcessBuilderFactoryInterface
{
    ...
    public function create($arguments = array())
    {
        ...
        if (static::$emulateSfLTS) {
            ...
            if (method_exists('FluxMedia\Symfony\Component\Process\ProcessUtils', 'escapeArgument')) {
                $script = implode(' ', array_map(array('FluxMedia\Symfony\Component\Process\ProcessUtils', 'escapeArgument'), $arguments));
            } else {
                $script = $arguments;
            }
    ...
    private function detectEmulation()
    {
        ...
        static::$emulateSfLTS = !method_exists('FluxMedia\Symfony\Component\Process\ProcessBuilder', 'setPrefix');
