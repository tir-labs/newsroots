...
use FluxMedia\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use FluxMedia\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use FluxMedia\Monolog\Logger;
use FluxMedia\Monolog\ResettableInterface;
