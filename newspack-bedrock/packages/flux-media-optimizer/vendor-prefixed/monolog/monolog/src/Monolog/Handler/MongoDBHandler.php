...
use FluxMedia\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \FluxMedia\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \FluxMedia\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
