...
namespace FluxMedia\Monolog\Handler;

use FluxMedia\Monolog\Formatter\LineFormatter;
use FluxMedia\Monolog\Formatter\FormatterInterface;
use FluxMedia\Monolog\Logger;
 ...
 *
 *      $logger = new \FluxMedia\Monolog\Logger('all', array(new \FluxMedia\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['FluxMedia\\Monolog\\'], // array Hide calls of classes started with...
