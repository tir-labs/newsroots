...
namespace FluxMedia\Monolog;

use DateTimeZone;
use FluxMedia\Monolog\Handler\HandlerInterface;
use FluxMedia\Psr\Log\LoggerInterface;
use FluxMedia\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \FluxMedia\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
