...
use FluxMedia\Psr\Container\ContainerInterface;
use FluxMedia\Symfony\Contracts\Service\Attribute\Required;
use FluxMedia\Symfony\Contracts\Service\Attribute\SubscribedService;

fluxmedia_trigger_deprecation('symfony/contracts', 'v3.5', '"%s" is deprecated, use "ServiceMethodsSubscriberTrait" instead.', ServiceSubscriberTrait::class);
