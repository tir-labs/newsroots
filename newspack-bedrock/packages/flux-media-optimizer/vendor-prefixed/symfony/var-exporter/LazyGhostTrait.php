...
use FluxMedia\Symfony\Component\VarExporter\Internal\LazyObjectRegistry as Registry;
use FluxMedia\Symfony\Component\VarExporter\Internal\LazyObjectState;
use FluxMedia\Symfony\Component\VarExporter\Internal\LazyObjectTrait;
...
trait LazyGhostTrait
{
    ...
    public static function createLazyGhost(\Closure|array $initializer, ?array $skippedProperties = null, ?object $instance = null): static
    {
        if (\is_array($initializer)) {
            fluxmedia_trigger_deprecation('symfony/var-exporter', '6.4', 'Per-property lazy-initializers are deprecated and won\'t be supported anymore in 7.0, use an object initializer instead.');
        }
