...
namespace FluxMedia\Symfony\Component\VarExporter;

use FluxMedia\Symfony\Component\VarExporter\Exception\LogicException;
use FluxMedia\Symfony\Component\VarExporter\Internal\Hydrator;
use FluxMedia\Symfony\Component\VarExporter\Internal\LazyObjectRegistry;
...
final class ProxyHelper
{
    ...
    public static function generateLazyGhost(\ReflectionClass $class): string
    {
        ...
        return <<<EOPHP
             extends \\{$class->name} implements \FluxMedia\Symfony\Component\VarExporter\LazyObjectInterface
            {
                use \FluxMedia\Symfony\Component\VarExporter\LazyGhostTrait;
