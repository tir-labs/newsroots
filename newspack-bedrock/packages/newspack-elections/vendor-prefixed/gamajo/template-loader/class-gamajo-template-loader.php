 ...
 *
 * @package   Govpack_Vendor_Gamajo_Template_Loader
 * @author    Gary Jones
...
if ( ! class_exists( 'Govpack_Vendor_Gamajo_Template_Loader' ) ) {
	 ...
	 * @author  Gary Jones
	 */
	class Govpack_Vendor_Gamajo_Template_Loader {
		/**
		 ...
		 *                         Default is 'data'.
		 * @return Govpack_Vendor_Gamajo_Template_Loader
		 */
