...
abstract class AbstractCsv implements ByteSequence
{
     ...
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\AbstractCsv::supportsStreamFilterOnRead() or League\Csv\AbstractCsv::supportsStreamFilterOnWrite() instead', since:'league/csv:9.7.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\AbstractCsv::toString() instead', since:'league/csv:9.7.0')]
     ...
     * Retrieves the CSV content
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\AbstractCsv::toString() instead', since:'league/csv:9.1.0')]
     ...
     */
    #[Deprecated(message:'the method no longer affect the outcome of the class, use Govpack\Vendor\League\Csv\HttpHeaders::forFileDownload instead', since:'league/csv:9.17.0')]
     ...
     * @throws Exception
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\AbstractCsv::download() instead', since:'league/csv:9.18.0')]
