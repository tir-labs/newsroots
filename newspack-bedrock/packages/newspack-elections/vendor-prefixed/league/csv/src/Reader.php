...
use Govpack\Vendor\League\Csv\Serializer\Denormalizer;
use Govpack\Vendor\League\Csv\Serializer\MappingFailed;
use Govpack\Vendor\League\Csv\Serializer\TypeCastingFailed;
use SplFileObject;
...
class Reader extends AbstractCsv implements TabularDataReader, JsonSerializable
{
    ...
    /**
     * @param \Govpack\Vendor\League\Csv\Query\Predicate|Closure(array, array-key): bool $predicate
     *
     * @throws Exception
     * @throws SyntaxError
     */
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\Reader::nth() instead', since:'league/csv:9.9.0')]
     ...
     * @throws TypeCastingFailed
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\Reader::getRecordsAsObject() instead', since:'league/csv:9.15.0')]
