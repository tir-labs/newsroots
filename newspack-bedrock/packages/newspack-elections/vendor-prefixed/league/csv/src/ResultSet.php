...
class ResultSet implements TabularDataReader, JsonSerializable
{
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\Resultset::nth() instead', since:'league/csv:9.9.0')]
     ...
     * @throws TypeCastingFailed
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\ResultSet::getRecordsAsObject() instead', since:'league/csv:9.15.0')]
