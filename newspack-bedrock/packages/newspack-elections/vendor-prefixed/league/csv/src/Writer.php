...
class Writer extends AbstractCsv implements TabularDataWriter
{
     ...
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\Writer::getEndOfLine()', since:'league/csv:9.8.0')]
     ...
     */
    #[Deprecated(message:'use Govpack\Vendor\League\Csv\Writer::setEndOfLine()', since:'league/csv:9.8.0')]
