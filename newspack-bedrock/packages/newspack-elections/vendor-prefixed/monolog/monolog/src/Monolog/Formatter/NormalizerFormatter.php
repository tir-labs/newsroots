...
use Govpack\Vendor\Monolog\DateTimeImmutable;
...
class NormalizerFormatter implements FormatterInterface
{
    ...
    public function __construct(?string $dateFormat = null)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use Govpack\Vendor\Monolog\'s NormalizerFormatter');
        }
    }
