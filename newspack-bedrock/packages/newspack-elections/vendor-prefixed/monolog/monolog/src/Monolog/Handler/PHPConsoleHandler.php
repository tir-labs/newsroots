...
namespace Govpack\Vendor\Monolog\Handler;

use Govpack\Vendor\Monolog\Formatter\LineFormatter;
use Govpack\Vendor\Monolog\Formatter\FormatterInterface;
 ...
 *
 *      $logger = new \Govpack\Vendor\Monolog\Logger('all', array(new \Govpack\Vendor\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Govpack\\Vendor\\Monolog\\'], // array Hide calls of classes started with...
