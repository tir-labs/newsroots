...
namespace Govpack\Vendor\Monolog;

use DateTimeZone;
use Govpack\Vendor\Monolog\Handler\HandlerInterface;
use Govpack\Vendor\Psr\Log\LoggerInterface;
use Govpack\Vendor\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \Govpack\Vendor\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
