...
class RestApi {
	...
	public function get_option(): array {
		...
		// Editor JS enables AI buttons when ai_api_key is truthy. Use WordPress AI availability instead of a vendor key.
		$option['ai_api_key'] = \SlimSEO\MetaTags\AI::is_available();
