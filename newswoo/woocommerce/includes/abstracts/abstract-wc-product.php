...
class WC_Product extends WC_Abstract_Legacy_Product {
	...
	*/
	 ...
	 * @return void
	 */
	public function set_manage_stock( $manage_stock ) { $this->set_prop( 'manage_stock', false ); }
	 ...
	 * @return void
	 */
	public function set_stock_status( $status = 'instock' ) { $this->set_prop( 'stock_status', 'instock' ); }
	 ...
	 * @return void
	 */
	public function set_backorders( $backorders ) { $this->set_prop( 'backorders', 'no' ); }
	 ...
	 * @return void
	 */
	public function set_low_stock_amount( $amount ) { /* Removed in NewsWoo */ }
	 ...
	 * @return void
	 */
	public function set_sold_individually( $sold_individually ) { $this->set_prop( 'sold_individually', false ); }
